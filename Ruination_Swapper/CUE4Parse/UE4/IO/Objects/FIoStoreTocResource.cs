...
namespace CUE4Parse.UE4.IO.Objects
{
    ...
    public class FIoStoreTocResource
    {
        ...
        public long[] CompressionBlockPositions;
        public long[] ChunkOffsetLengthsPositions;
        ...
        public FIoStoreTocResource(FArchive Ar, EIoStoreTocReadOptions readOptions = EIoStoreTocReadOptions.Default)
        {
            ...
            ChunkOffsetLengthsPositions = new long[Header.TocEntryCount];
            for (int i = 0; i < Header.TocEntryCount; i++)
            {
                ChunkOffsetLengthsPositions[i] = archive.Position;
            ...
            CompressionBlockPositions = new long[Header.TocCompressedBlockEntryCount];
            for (int i = 0; i < Header.TocCompressedBlockEntryCount; i++)
            {
                CompressionBlockPositions[i] = archive.Position;
